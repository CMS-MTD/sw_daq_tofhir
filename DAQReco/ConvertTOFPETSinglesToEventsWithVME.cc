...
int main(int argc, char* argv[]){
    ...
    string singleFile= "/home/daq/2020_02_cmstiming_BTL/TOFHIR/RecoData/v1/RecoWithTracks/run"+runNumber+"_single.root";
    TFile *tofhirFile=new TFile(singleFile.c_str(),"read");
    TTree *tofhirTree = (TTree*)tofhirFile->Get("data");
    if( tofhirTree != NULL ) cout << "\n>>> got TOFHIR tree from file " << singleFile << " with " << tofhirTree->GetEntries() << " entries" << endl;
    else exit(-1);
